...
pt(43).blockname = 'task_space/ee_rot_des';
...
pt(44).blockname = 'task_space/f_in_w';
...
pt(45).blockname = 'task_space/m_in_w';
...
pt(46).blockname = 'task_space/p_in_m';
...
pt(47).blockname = 'task_space/t_in_w';
...
pt(48).blockname = 'task_space/twa_flange_offset';
...
pt(49).blockname = 'task_space/twa_gamma';
...
pt(50).blockname = 'task_space/use_twa';
...
pt(51).blockname = 'task_space/x_des';
...
pt(52).blockname = 'task_space/Unit Delay1';
pt(52).paramname = 'X0';
pt(52).class     = 'vector';
pt(52).nrows     = 6;
pt(52).ncols     = 1;
...
pt(53).blockname = 'task_space/Unit Delay3';
pt(53).paramname = 'X0';
pt(53).class     = 'scalar';
pt(53).nrows     = 1;
pt(53).ncols     = 1;
...
pt(54).blockname = 'task_space/Unit Delay4';
pt(54).paramname = 'X0';
pt(54).class     = 'vector';
pt(54).nrows     = 3;
pt(54).ncols     = 1;
...
pt(69).blockname = 'Quintic Poly/N-Sample Switch/N-Sample Enable';
pt(69).paramname = 'TARGETCNT';
pt(69).class     = 'scalar';
pt(69).nrows     = 1;
pt(69).ncols     = 1;
...
pt(71).blockname = 'Scopes/Fir Filter/vel_filter_coeffs';
...
pt(72).blockname = 'Scopes/Fir Filter/Gain';
...
pt(73).blockname = 'Scopes/Fir Filter/Discrete FIR Filter';
pt(73).paramname = 'IC';
pt(73).class     = 'scalar';
pt(73).nrows     = 1;
pt(73).ncols     = 1;
...
pt(74).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(74).paramname = 'X0';
pt(74).class     = 'scalar';
pt(74).nrows     = 1;
pt(74).ncols     = 1;
...
pt(75).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
pt(75).paramname = 'WtEt';
pt(75).class     = 'scalar';
pt(75).nrows     = 1;
pt(75).ncols     = 1;
...
pt(76).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(77).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(78).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(78).paramname = 'IC';
pt(78).class     = 'scalar';
pt(78).nrows     = 1;
pt(78).ncols     = 1;
