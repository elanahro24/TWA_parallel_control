...
pt(16).blockname = 'Homing/meas_macro_len';
...
pt(18).blockname = 'Homing/velmex_pitch';
...
pt(19).blockname = 'Homing/Unit Delay1';
pt(19).paramname = 'X0';
pt(19).class     = 'vector';
pt(19).nrows     = 3;
pt(19).ncols     = 1;
...
pt(20).blockname = 'Homing/Unit Delay2';
pt(20).paramname = 'X0';
pt(20).class     = 'col-mat';
pt(20).nrows     = 3;
pt(20).ncols     = 3;
...
pt(21).blockname = 'Homing/Unit Delay3';
pt(21).paramname = 'X0';
pt(21).class     = 'vector';
pt(21).nrows     = 3;
pt(21).ncols     = 1;
...
pt(22).blockname = 'Homing/Unit Delay4';
pt(22).paramname = 'X0';
pt(22).class     = 'vector';
pt(22).nrows     = 3;
pt(22).ncols     = 1;
...
pt(23).blockname = 'PID Controller/manual_current';
...
pt(24).blockname = 'PID Controller/pid_mode';
...
pt(25).blockname = 'PID Controller/reset_integrator';
...
pt(26).blockname = 'PID Controller/Kd';
...
pt(27).blockname = 'PID Controller/Ki';
...
pt(28).blockname = 'PID Controller/Kp';
...
pt(29).blockname = 'PID Controller/Integrator';
...
pt(30).blockname = 'PID Controller/Saturation';
...
pt(39).blockname = 'task_space/ee_rot';
...
pt(40).blockname = 'task_space/x_des';
...
pt(41).blockname = 'task_space/Unit Delay';
pt(41).paramname = 'X0';
pt(41).class     = 'vector';
pt(41).nrows     = 3;
pt(41).ncols     = 1;
...
pt(42).blockname = 'task_space/Unit Delay2';
pt(42).paramname = 'X0';
pt(42).class     = 'vector';
pt(42).nrows     = 3;
pt(42).ncols     = 1;
...
pt(43).blockname = 'Encoders/Counts To Turns/enc_res';
...
pt(44).blockname = 'Encoders/Counts To Turns/gear_ratio';
...
pt(45).blockname = 'Encoders/Counts To Turns1/enc_res';
...
pt(46).blockname = 'Encoders/Counts To Turns1/gear_ratio';
...
pt(47).blockname = 'Encoders/Counts To Turns2/enc_res';
...
pt(48).blockname = 'Encoders/Counts To Turns2/gear_ratio';
...
pt(51).blockname = 'Encoders/Counts To Turns4/enc_res';
...
pt(52).blockname = 'Encoders/Counts To Turns4/gear_ratio';
...
pt(53).blockname = 'Encoders/Counts To Turns5/enc_res';
...
pt(54).blockname = 'Encoders/Counts To Turns5/gear_ratio';
...
pt(62).blockname = 'task_space/gear_ratio/meas_macro_len';
...
pt(63).blockname = 'task_space/gear_ratio/velmex_pitch';
...
pt(64).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(64).paramname = 'X0';
pt(64).class     = 'scalar';
pt(64).nrows     = 1;
pt(64).ncols     = 1;
...
pt(65).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
pt(65).paramname = 'WtEt';
pt(65).class     = 'scalar';
pt(65).nrows     = 1;
pt(65).ncols     = 1;
...
pt(66).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(67).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(68).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(68).paramname = 'IC';
pt(68).class     = 'scalar';
pt(68).nrows     = 1;
pt(68).ncols     = 1;
