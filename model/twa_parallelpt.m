...
pt(83).blockname = 'control_mode/task_space/res_rate_param';
...
pt(84).blockname = 'control_mode/task_space/t_in_w';
...
pt(85).blockname = 'control_mode/task_space/twa_flange_offset';
...
pt(86).blockname = 'control_mode/task_space/twa_gamma';
...
pt(87).blockname = 'control_mode/task_space/use_twa';
...
pt(88).blockname = 'control_mode/task_space/x_des';
...
pt(89).blockname = 'control_mode/task_space/Unit Delay1';
pt(89).paramname = 'X0';
pt(89).class     = 'vector';
pt(89).nrows     = 6;
pt(89).ncols     = 1;
...
pt(90).blockname = 'control_mode/task_space/Unit Delay2';
pt(90).paramname = 'X0';
pt(90).class     = 'vector';
pt(90).nrows     = 6;
pt(90).ncols     = 1;
...
pt(91).blockname = 'control_mode/task_space/Unit Delay3';
pt(91).paramname = 'X0';
pt(91).class     = 'scalar';
pt(91).nrows     = 1;
pt(91).ncols     = 1;
...
pt(92).blockname = 'control_mode/task_space/Unit Delay4';
pt(92).paramname = 'X0';
pt(92).class     = 'vector';
pt(92).nrows     = 3;
pt(92).ncols     = 1;
...
pt(93).blockname = 'control_mode/task_space/Unit Delay5';
pt(93).paramname = 'X0';
pt(93).class     = 'vector';
pt(93).nrows     = 3;
pt(93).ncols     = 1;
...
pt(94).blockname = 'control_mode/task_space/Unit Delay7';
pt(94).paramname = 'X0';
pt(94).class     = 'vector';
pt(94).nrows     = 6;
pt(94).ncols     = 1;
...
pt(95).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(95).paramname = 'X0';
pt(95).class     = 'scalar';
pt(95).nrows     = 1;
pt(95).ncols     = 1;
...
pt(96).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
pt(96).paramname = 'WtEt';
pt(96).class     = 'scalar';
pt(96).nrows     = 1;
pt(96).ncols     = 1;
...
pt(97).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(98).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(99).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(99).paramname = 'IC';
pt(99).class     = 'scalar';
pt(99).nrows     = 1;
pt(99).ncols     = 1;
...
pt(100).blockname = 'control_mode/detect change/Detect Change/Delay Input1';
pt(100).paramname = 'X0';
pt(100).class     = 'vector';
pt(100).nrows     = 6;
pt(100).ncols     = 1;
