...
pt(18).blockname = 'PID Controller/reset_mu_integ';
...
pt(19).blockname = 'PID Controller/Kd';
...
pt(20).blockname = 'PID Controller/Kd_mu';
...
pt(22).blockname = 'PID Controller/Ki_mu';
...
pt(23).blockname = 'PID Controller/Kp';
...
pt(24).blockname = 'PID Controller/Kp_mu';
...
pt(25).blockname = 'PID Controller/Integrator';
...
pt(26).blockname = 'PID Controller/Integrator1';
...
pt(30).blockname = 'PID Controller/Saturation1';
...
pt(32).blockname = 'PID Controller/saturate_int';
...
pt(34).blockname = 'PID Controller/saturate_int1';
...
pt(40).blockname = 'control_mode/mode';
...
pt(41).blockname = 'control_mode/q_des_usr';
...
pt(42).blockname = 'control_mode/Unit Delay1';
pt(42).paramname = 'X0';
pt(42).class     = 'vector';
pt(42).nrows     = 6;
pt(42).ncols     = 1;
...
pt(45).blockname = 'Encoders/Counts To Turns1/velmex_pitch';
...
pt(46).blockname = 'Encoders/Counts To Turns2/enc_res';
...
pt(47).blockname = 'Encoders/Counts To Turns2/gear_ratio';
...
pt(48).blockname = 'Encoders/Counts To Turns2/velmex_pitch';
...
pt(49).blockname = 'Encoders/Counts To Turns3/enc_res';
...
pt(50).blockname = 'Encoders/Counts To Turns3/gear_ratio';
...
pt(51).blockname = 'Encoders/Counts To Turns3/velmex_pitch';
...
pt(52).blockname = 'Encoders/Counts To Turns4/helix_rad';
...
pt(53).blockname = 'Encoders/Counts To Turns4/twa_len';
...
pt(54).blockname = 'Encoders/Counts To Turns4/wire_delta';
...
pt(55).blockname = 'Encoders/Counts To Turns4/enc_res';
...
pt(56).blockname = 'Encoders/Counts To Turns4/gear_ratio';
...
pt(57).blockname = 'Encoders/Counts To Turns5/helix_rad';
...
pt(58).blockname = 'Encoders/Counts To Turns5/twa_len';
...
pt(59).blockname = 'Encoders/Counts To Turns5/wire_delta';
...
pt(60).blockname = 'Encoders/Counts To Turns5/enc_res';
...
pt(61).blockname = 'Encoders/Counts To Turns5/gear_ratio';
...
pt(62).blockname = 'Encoders/Counts To Turns6/helix_rad';
...
pt(63).blockname = 'Encoders/Counts To Turns6/twa_len';
...
pt(64).blockname = 'Encoders/Counts To Turns6/wire_delta';
...
pt(67).blockname = 'PID Controller/Discrete Derivative/UD';
pt(67).paramname = 'X0';
pt(67).class     = 'scalar';
pt(67).nrows     = 1;
pt(67).ncols     = 1;
...
pt(68).blockname = 'PID Controller/Discrete Derivative/TSamp';
pt(68).paramname = 'WtEt';
pt(68).class     = 'scalar';
pt(68).nrows     = 1;
pt(68).ncols     = 1;
...
pt(69).blockname = 'PID Controller/Discrete Derivative1/UD';
pt(69).paramname = 'X0';
pt(69).class     = 'scalar';
pt(69).nrows     = 1;
pt(69).ncols     = 1;
...
pt(70).blockname = 'PID Controller/Discrete Derivative1/TSamp';
pt(70).paramname = 'WtEt';
pt(70).class     = 'scalar';
pt(70).nrows     = 1;
pt(70).ncols     = 1;
...
pt(72).blockname = 'Quintic Poly/N-Sample Switch/N-Sample Enable';
pt(72).paramname = 'ACTLEVEL';
pt(72).class     = 'scalar';
pt(72).nrows     = 1;
pt(72).ncols     = 1;
pt(72).subsource = 'SS_UINT32';
pt(72).ndims     = '2';
pt(72).size      = '[]';

pt(73).blockname = 'Scopes/Fir Filter/vel_filter_coeffs';
...
pt(74).blockname = 'Scopes/Fir Filter/Gain';
...
pt(75).blockname = 'Scopes/Fir Filter/Discrete FIR Filter';
pt(75).paramname = 'IC';
pt(75).class     = 'scalar';
pt(75).nrows     = 1;
pt(75).ncols     = 1;
...
pt(76).blockname = 'control_mode/task_space/b_in_w';
...
pt(77).blockname = 'control_mode/task_space/dt';
...
pt(78).blockname = 'control_mode/task_space/ee_rot_des';
...
pt(79).blockname = 'control_mode/task_space/f_in_w';
...
pt(80).blockname = 'control_mode/task_space/m_in_w';
...
pt(82).blockname = 'control_mode/task_space/res_rate_param';
...
pt(83).blockname = 'control_mode/task_space/t_in_w';
...
pt(84).blockname = 'control_mode/task_space/twa_flange_offset';
...
pt(85).blockname = 'control_mode/task_space/twa_gamma';
...
pt(86).blockname = 'control_mode/task_space/use_twa';
...
pt(87).blockname = 'control_mode/task_space/x_des';
...
pt(88).blockname = 'control_mode/task_space/Unit Delay1';
pt(88).paramname = 'X0';
pt(88).class     = 'vector';
pt(88).nrows     = 6;
pt(88).ncols     = 1;
...
pt(89).blockname = 'control_mode/task_space/Unit Delay3';
pt(89).paramname = 'X0';
pt(89).class     = 'scalar';
pt(89).nrows     = 1;
pt(89).ncols     = 1;
...
pt(90).blockname = 'control_mode/task_space/Unit Delay6';
pt(90).paramname = 'X0';
pt(90).class     = 'vector';
pt(90).nrows     = 3;
pt(90).ncols     = 1;
...
pt(91).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(91).paramname = 'X0';
pt(91).class     = 'scalar';
pt(91).nrows     = 1;
pt(91).ncols     = 1;
...
pt(92).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
pt(92).paramname = 'WtEt';
pt(92).class     = 'scalar';
pt(92).nrows     = 1;
pt(92).ncols     = 1;
...
pt(93).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(94).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(95).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(95).paramname = 'IC';
pt(95).class     = 'scalar';
pt(95).nrows     = 1;
pt(95).ncols     = 1;
...
pt(96).blockname = 'control_mode/detect change/Detect Change/Delay Input1';
pt(96).paramname = 'X0';
pt(96).class     = 'vector';
pt(96).nrows     = 6;
pt(96).ncols     = 1;
