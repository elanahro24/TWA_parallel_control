...
pt(17).blockname = 'PID Controller/manual_current';
...
pt(18).blockname = 'PID Controller/pid_mode';
...
pt(19).blockname = 'PID Controller/reset_integrator';
...
pt(33).blockname = 'task_space/b_in_w';
...
pt(35).blockname = 'task_space/ee_rot_des';
...
pt(36).blockname = 'task_space/f_in_w';
...
pt(37).blockname = 'task_space/m_in_w';
...
pt(38).blockname = 'task_space/p_in_m';
...
pt(39).blockname = 'task_space/res_rate_param';
...
pt(40).blockname = 'task_space/t_in_w';
...
pt(41).blockname = 'task_space/twa_flange_offset';
...
pt(42).blockname = 'task_space/twa_gamma';
...
pt(43).blockname = 'task_space/use_twa';
...
pt(44).blockname = 'task_space/x_des';
...
pt(45).blockname = 'task_space/Unit Delay1';
pt(45).paramname = 'X0';
pt(45).class     = 'vector';
pt(45).nrows     = 6;
pt(45).ncols     = 1;
...
pt(46).blockname = 'task_space/Unit Delay3';
pt(46).paramname = 'X0';
pt(46).class     = 'scalar';
pt(46).nrows     = 1;
pt(46).ncols     = 1;
...
pt(47).blockname = 'task_space/Unit Delay4';
pt(47).paramname = 'X0';
pt(47).class     = 'vector';
pt(47).nrows     = 3;
pt(47).ncols     = 1;
...
pt(48).blockname = 'Encoders/Counts To Turns1/enc_res';
...
pt(49).blockname = 'Encoders/Counts To Turns1/gear_ratio';
...
pt(50).blockname = 'Encoders/Counts To Turns1/velmex_pitch';
...
pt(51).blockname = 'Encoders/Counts To Turns2/enc_res';
...
pt(52).blockname = 'Encoders/Counts To Turns2/gear_ratio';
...
pt(53).blockname = 'Encoders/Counts To Turns2/velmex_pitch';
...
pt(54).blockname = 'Encoders/Counts To Turns3/enc_res';
...
pt(55).blockname = 'Encoders/Counts To Turns3/gear_ratio';
...
pt(56).blockname = 'Encoders/Counts To Turns3/velmex_pitch';
...
pt(57).blockname = 'Encoders/Counts To Turns4/enc_res';
...
pt(58).blockname = 'Encoders/Counts To Turns4/gear_ratio';
...
pt(61).blockname = 'Encoders/Counts To Turns6/enc_res';
...
pt(62).blockname = 'Encoders/Counts To Turns6/gear_ratio';
...
pt(71).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(71).paramname = 'X0';
pt(71).class     = 'scalar';
pt(71).nrows     = 1;
pt(71).ncols     = 1;
...
pt(72).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
pt(72).paramname = 'WtEt';
pt(72).class     = 'scalar';
pt(72).nrows     = 1;
pt(72).ncols     = 1;
...
pt(73).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(74).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(75).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(75).paramname = 'IC';
pt(75).class     = 'scalar';
pt(75).nrows     = 1;
pt(75).ncols     = 1;
