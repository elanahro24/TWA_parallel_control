...
pt(41).blockname = 'task_space/ee_rot';
...
pt(43).blockname = 'task_space/Unit Delay';
pt(43).paramname = 'X0';
pt(43).class     = 'vector';
pt(43).nrows     = 3;
pt(43).ncols     = 1;
...
pt(64).blockname = 'task_space/gear_ratio/meas_macro_len';
...
pt(65).blockname = 'task_space/gear_ratio/velmex_pitch';
...
pt(66).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(66).paramname = 'X0';
pt(66).class     = 'scalar';
pt(66).nrows     = 1;
pt(66).ncols     = 1;
...
pt(67).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
...
pt(68).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(69).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(70).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(70).paramname = 'IC';
pt(70).class     = 'scalar';
pt(70).nrows     = 1;
pt(70).ncols     = 1;
