...
pt(47).blockname = 'task_space/twa_flange_offset';
...
pt(48).blockname = 'task_space/twa_gamma';
...
pt(49).blockname = 'task_space/use_twa';
...
pt(50).blockname = 'task_space/x_des';
...
pt(51).blockname = 'task_space/Unit Delay1';
pt(51).paramname = 'X0';
pt(51).class     = 'vector';
pt(51).nrows     = 3;
pt(51).ncols     = 1;
...
pt(52).blockname = 'task_space/Unit Delay2';
pt(52).paramname = 'X0';
pt(52).class     = 'vector';
pt(52).nrows     = 3;
pt(52).ncols     = 1;
...
pt(53).blockname = 'Encoders/Counts To Turns/enc_res';
...
pt(54).blockname = 'Encoders/Counts To Turns/gear_ratio';
...
pt(65).blockname = 'PID Controller/Discrete Derivative/UD';
pt(65).paramname = 'X0';
pt(65).class     = 'scalar';
pt(65).nrows     = 1;
pt(65).ncols     = 1;
...
pt(66).blockname = 'PID Controller/Discrete Derivative/TSamp';
...
pt(67).blockname = 'Quintic Poly/N-Sample Switch/N-Sample Enable';
pt(67).paramname = 'TARGETCNT';
pt(67).class     = 'scalar';
pt(67).nrows     = 1;
pt(67).ncols     = 1;
pt(67).subsource = 'SS_UINT32';
pt(67).ndims     = '2';
pt(67).size      = '[]';

pt(68).blockname = 'Quintic Poly/N-Sample Switch/N-Sample Enable';
pt(68).paramname = 'ACTLEVEL';
pt(68).class     = 'scalar';
pt(68).nrows     = 1;
pt(68).ncols     = 1;
pt(68).subsource = 'SS_UINT32';
pt(68).ndims     = '2';
pt(68).size      = '[]';

pt(69).blockname = 'Scopes/Fir Filter/vel_filter_coeffs';
...
pt(70).blockname = 'Scopes/Fir Filter/Gain';
...
pt(71).blockname = 'Scopes/Fir Filter/Discrete FIR Filter';
pt(71).paramname = 'IC';
pt(71).class     = 'scalar';
pt(71).nrows     = 1;
pt(71).ncols     = 1;
...
pt(72).blockname = 'task_space/gear_ratio/helix_rad';
...
pt(73).blockname = 'task_space/gear_ratio/meas_macro_len';
...
pt(74).blockname = 'task_space/gear_ratio/meas_twa_len';
...
pt(75).blockname = 'task_space/gear_ratio/velmex_pitch';
...
pt(76).blockname = 'task_space/gear_ratio/wire_delta';
...
pt(77).blockname = 'Encoders/Derivative/Discrete Derivative/UD';
pt(77).paramname = 'X0';
pt(77).class     = 'scalar';
pt(77).nrows     = 1;
pt(77).ncols     = 1;
...
pt(78).blockname = 'Encoders/Derivative/Discrete Derivative/TSamp';
pt(78).paramname = 'WtEt';
pt(78).class     = 'scalar';
pt(78).nrows     = 1;
pt(78).ncols     = 1;
...
pt(79).blockname = 'Encoders/Derivative/Fir Filter/vel_filter_coeffs';
...
pt(80).blockname = 'Encoders/Derivative/Fir Filter/Gain';
...
pt(81).blockname = 'Encoders/Derivative/Fir Filter/Discrete FIR Filter';
pt(81).paramname = 'IC';
pt(81).class     = 'scalar';
pt(81).nrows     = 1;
pt(81).ncols     = 1;
