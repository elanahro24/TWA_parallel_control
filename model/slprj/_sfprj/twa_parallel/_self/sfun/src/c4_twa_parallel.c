...
static const char *c4_debug_family_names[10] = { "converg_rad", "velmex_limit",
  "velmex_stroke", "nargin", "nargout", "des_macro_len", "meas_macro_len",
...
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static boolean_T c4_all(SFc4_twa_parallelInstanceStruct *chartInstance, real_T
  c4_x[3]);
...
static void sf_c4_twa_parallel(SFc4_twa_parallelInstanceStruct *chartInstance)
{
  ...
  int32_T c4_i9;
  real_T c4_d_hoistedGlobal[6];
  int32_T c4_i10;
  real_T c4_des_macro_len[3];
  int32_T c4_i11;
  real_T c4_meas_macro_len[3];
  real_T c4_velmex_pitch;
  int32_T c4_i12;
  real_T c4_q_cur[6];
  uint32_T c4_debug_family_var_map[10];
  static const char *c4_sv0[10] = { "converg_rad", "velmex_limit",
    "velmex_stroke", "nargin", "nargout", "des_macro_len",
    "meas_macro_len", "velmex_pitch", "q_cur", "qmacro_des" };

  real_T c4_converg_rad;
  ...
  int32_T c4_i14;
  int32_T c4_i15;
  real_T c4_b_velmex_stroke[3];
  boolean_T c4_x;
  boolean_T c4_b_x;
  real_T c4_y;
  int32_T c4_i16;
  real_T c4_c_velmex_stroke[3];
  boolean_T c4_c_x;
  boolean_T c4_d_x;
  real_T c4_b_y;
  real_T c4_A;
  ...
  real_T (*c4_b_q_cur)[6];
  real_T (*c4_b_meas_macro_len)[3];
  real_T (*c4_b_des_macro_len)[3];
  c4_b_q_cur = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 3);
  c4_b_velmex_pitch = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c4_b_qmacro_des = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_meas_macro_len = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_des_macro_len = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG,3);
  for (c4_i3 = 0; c4_i3 < 3; c4_i3 = c4_i3 + 1) {
    _SFD_DATA_RANGE_CHECK((*c4_b_des_macro_len)[c4_i3], 0U);
  }

  for (c4_i4 = 0; c4_i4 < 3; c4_i4 = c4_i4 + 1) {
    _SFD_DATA_RANGE_CHECK((*c4_b_meas_macro_len)[c4_i4], 1U);
  }

  for (c4_i5 = 0; c4_i5 < 3; c4_i5 = c4_i5 + 1) {
    _SFD_DATA_RANGE_CHECK((*c4_b_qmacro_des)[c4_i5], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c4_b_velmex_pitch, 3U);
  for (c4_i6 = 0; c4_i6 < 6; c4_i6 = c4_i6 + 1) {
    _SFD_DATA_RANGE_CHECK((*c4_b_q_cur)[c4_i6], 4U);
  }
  ...
  for (c4_i7 = 0; c4_i7 < 3; c4_i7 = c4_i7 + 1) {
    c4_hoistedGlobal[c4_i7] = (*c4_b_des_macro_len)[c4_i7];
  }

  for (c4_i8 = 0; c4_i8 < 3; c4_i8 = c4_i8 + 1) {
    c4_b_hoistedGlobal[c4_i8] = (*c4_b_meas_macro_len)[c4_i8];
  }

  c4_c_hoistedGlobal = *c4_b_velmex_pitch;
  for (c4_i9 = 0; c4_i9 < 6; c4_i9 = c4_i9 + 1) {
    c4_d_hoistedGlobal[c4_i9] = (*c4_b_q_cur)[c4_i9];
  }

  for (c4_i10 = 0; c4_i10 < 3; c4_i10 = c4_i10 + 1) {
    c4_des_macro_len[c4_i10] = c4_hoistedGlobal[c4_i10];
  }

  for (c4_i11 = 0; c4_i11 < 3; c4_i11 = c4_i11 + 1) {
    c4_meas_macro_len[c4_i11] = c4_b_hoistedGlobal[c4_i11];
  }

  c4_velmex_pitch = c4_c_hoistedGlobal;
  for (c4_i12 = 0; c4_i12 < 6; c4_i12 = c4_i12 + 1) {
    c4_q_cur[c4_i12] = c4_d_hoistedGlobal[c4_i12];
  }

  sf_debug_symbol_scope_push_eml(0U, 10U, 10U, c4_sv0, c4_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c4_converg_rad, c4_c_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(&c4_velmex_limit, c4_c_sf_marshall, 1U);
  ...
  sf_debug_symbol_scope_add_eml(&c4_des_macro_len, c4_sf_marshall, 5U);
  sf_debug_symbol_scope_add_eml(&c4_meas_macro_len, c4_sf_marshall, 6U);
  sf_debug_symbol_scope_add_eml(&c4_velmex_pitch, c4_c_sf_marshall, 7U);
  sf_debug_symbol_scope_add_eml(&c4_q_cur, c4_b_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(&c4_qmacro_des, c4_sf_marshall, 9U);
  CV_EML_FCN(0, 0);
  ...
  for (c4_i13 = 0; c4_i13 < 3; c4_i13 = c4_i13 + 1) {
    c4_qmacro_des[c4_i13] = c4_q_cur[c4_i13];
  }
  ...
  for (c4_i14 = 0; c4_i14 < 3; c4_i14 = c4_i14 + 1) {
    c4_velmex_stroke[c4_i14] = 0.0;
  }

  _SFD_EML_CALL(0,13);
  c4_velmex_stroke[0] = c4_des_macro_len[0] - c4_meas_macro_len[0];
  _SFD_EML_CALL(0,14);
  c4_velmex_stroke[1] = c4_des_macro_len[1] - c4_meas_macro_len[1];
  _SFD_EML_CALL(0,15);
  c4_velmex_stroke[2] = c4_des_macro_len[2] - c4_meas_macro_len[2];
  _SFD_EML_CALL(0,18);
  for (c4_i15 = 0; c4_i15 < 3; c4_i15 = c4_i15 + 1) {
    c4_b_velmex_stroke[c4_i15] = c4_velmex_stroke[c4_i15];
  }

  c4_x = c4_all(chartInstance, c4_b_velmex_stroke);
  c4_b_x = c4_x;
  c4_y = (real_T)c4_b_x;
  if (CV_EML_COND(0, 0, c4_y < c4_velmex_limit)) {
    for (c4_i16 = 0; c4_i16 < 3; c4_i16 = c4_i16 + 1) {
      c4_c_velmex_stroke[c4_i16] = c4_velmex_stroke[c4_i16];
    }

    c4_c_x = c4_all(chartInstance, c4_c_velmex_stroke);
    c4_d_x = c4_c_x;
    c4_b_y = (real_T)c4_d_x;
    if (CV_EML_COND(0, 1, c4_b_y > c4_converg_rad)) {
      CV_EML_MCDC(0, 0, TRUE);
      CV_EML_IF(0, 0, TRUE);
      _SFD_EML_CALL(0,19);
      c4_A = c4_velmex_stroke[0];
      ...
      c4_qmacro_des[0] = c4_f_y;
      _SFD_EML_CALL(0,20);
      c4_b_A = c4_velmex_stroke[1];
      c4_b_B = c4_velmex_pitch;
      c4_h_x = c4_b_A;
      c4_g_y = c4_b_B;
      c4_i_x = c4_h_x;
      c4_h_y = c4_g_y;
      c4_j_x = c4_i_x;
      c4_i_y = c4_h_y;
      c4_j_y = c4_j_x / c4_i_y;
      c4_qmacro_des[1] = c4_j_y;
      _SFD_EML_CALL(0,21);
      c4_c_A = c4_velmex_stroke[2];
      c4_c_B = c4_velmex_pitch;
      c4_k_x = c4_c_A;
      c4_k_y = c4_c_B;
      c4_l_x = c4_k_x;
      c4_l_y = c4_k_y;
      c4_m_x = c4_l_x;
      c4_m_y = c4_l_y;
      c4_n_y = c4_m_x / c4_m_y;
      c4_qmacro_des[2] = c4_n_y;
      goto label_1;
    }
  }
 ...
 label_1:
  ...
  for (c4_i17 = 0; c4_i17 < 3; c4_i17 = c4_i17 + 1) {
    (*c4_b_qmacro_des)[c4_i17] = c4_qmacro_des[c4_i17];
  }
  ...
  c4_x[3])
{
 ...
 label_1:
  ...
  if (c4_k <= 3.0) {
    c4_b_k = c4_k;
    if (c4_b_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          c4_b_k), 1, 3, 1, 0) - 1] == 0.0) {
      return FALSE;
    } else {
      c4_k = c4_k + 1.0;
      goto label_1;
...
static const mxArray *c4_sf_marshall(void *chartInstanceVoid, void *c4_u)
{
  ...
  for (c4_i19 = 0; c4_i19 < 3; c4_i19 = c4_i19 + 1) {
    c4_b_u[c4_i19] = (*((real_T (*)[3])c4_u))[c4_i19];
  }
...
static const mxArray *c4_b_sf_marshall(void *chartInstanceVoid, void *c4_u)
{
  ...
  for (c4_i20 = 0; c4_i20 < 6; c4_i20 = c4_i20 + 1) {
    c4_b_u[c4_i20] = (*((real_T (*)[6])c4_u))[c4_i20];
  }
...
const mxArray *sf_c4_twa_parallel_get_eml_resolved_functions_info(void)
{
  ...
  for (c4_i21 = 0; c4_i21 < 33; c4_i21 = c4_i21 + 1) {
    ...
    sf_mex_addfield(c4_m0, sf_mex_create("nameCaptureInfo", &c4_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c4_i21
                    );
    sf_mex_addfield(c4_m0, sf_mex_create("nameCaptureInfo", &c4_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c4_i21
                    );
  }
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[33])
{
  ...
  c4_info[2].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c4_info[2].fileLength = 427U;
  c4_info[2].fileTime1 = 1221292338U;
  c4_info[2].fileTime2 = 0U;
  c4_info[3].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  ...
  c4_info[16].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c4_info[16].name = "islogical";
  c4_info[16].dominantType = "logical";
  c4_info[16].resolved = "[B]islogical";
  ...
  c4_info[25].context = "";
  c4_info[25].name = "abs";
  c4_info[25].dominantType = "logical";
  c4_info[25].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[25].fileLength = 566U;
  c4_info[25].fileTime1 = 1221292332U;
  c4_info[25].fileTime2 = 0U;
  c4_info[26].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[26].name = "isreal";
  c4_info[26].dominantType = "logical";
  c4_info[26].resolved = "[B]isreal";
  c4_info[26].fileLength = 0U;
  c4_info[26].fileTime1 = 0U;
  c4_info[26].fileTime2 = 0U;
  c4_info[27].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[27].name = "eml_scalar_abs";
  c4_info[27].dominantType = "logical";
  c4_info[27].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c4_info[27].fileLength = 461U;
  c4_info[27].fileTime1 = 1203473160U;
  ...
  c4_info[29].context = "";
  c4_info[29].name = "mrdivide";
  c4_info[29].dominantType = "double";
  c4_info[29].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c4_info[29].fileLength = 800U;
  c4_info[29].fileTime1 = 1238459490U;
  c4_info[29].fileTime2 = 0U;
  c4_info[30].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c4_info[30].name = "rdivide";
  c4_info[30].dominantType = "double";
  c4_info[30].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[30].fileLength = 403U;
  c4_info[30].fileTime1 = 1244760752U;
  c4_info[30].fileTime2 = 0U;
  c4_info[31].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[31].name = "eml_div";
  c4_info[31].dominantType = "double";
  c4_info[31].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c4_info[31].fileLength = 4269U;
  c4_info[31].fileTime1 = 1228119026U;
  c4_info[31].fileTime2 = 0U;
  c4_info[32].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c4_info[32].name = "isinteger";
  c4_info[32].dominantType = "double";
  c4_info[32].resolved = "[B]isinteger";
  ...
  , real_T c4_y[3])
{
  real_T c4_dv1[3];
  int32_T c4_i22;
  sf_mex_import(c4_name, sf_mex_dup(c4_qmacro_des), &c4_dv1, 1, 0, 0U, 1, 0U, 1,
                3);
  for (c4_i22 = 0; c4_i22 < 3; c4_i22 = c4_i22 + 1) {
    c4_y[c4_i22] = c4_dv1[c4_i22];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(290562137U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1691767492U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2642340386U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2905438047U);
}
...
mxArray *sf_c4_twa_parallel_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(2458080727U);
    pr[1] = (double)(253976125U);
    pr[2] = (double)(1913022276U);
    pr[3] = (double)(493613115U);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,0,570,652,-1,827);

        {
          static int condStart[] = { 573, 615 };

          static int condEnd[] = { 611, 652 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,0,573,652,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
...

        {
          ...
          real_T *c4_velmex_pitch;
          real_T (*c4_q_cur)[6];
          c4_q_cur = (real_T (*)[6])ssGetInputPortSignal(chartInstance->S, 3);
          c4_velmex_pitch = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c4_qmacro_des = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S,
            1);
          c4_meas_macro_len = (real_T (*)[3])ssGetInputPortSignal
            (chartInstance->S, 1);
          c4_des_macro_len = (real_T (*)[3])ssGetInputPortSignal
            (chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c4_des_macro_len);
          _SFD_SET_DATA_VALUE_PTR(1U, c4_meas_macro_len);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_qmacro_des);
          _SFD_SET_DATA_VALUE_PTR(3U, c4_velmex_pitch);
          _SFD_SET_DATA_VALUE_PTR(4U, c4_q_cur);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c4_twa_parallel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"twa_parallel","twa_parallel",4,4);
  ...
  ssSetChecksum0(S,(3622203895U));
  ssSetChecksum1(S,(2067580383U));
  ssSetChecksum2(S,(588574026U));
  ssSetChecksum3(S,(673213401U));
