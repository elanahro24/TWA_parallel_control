...
static void c2_emlrt_marshallIn(SFc2_twa_parallelInstanceStruct *chartInstance,
  const mxArray *c2_qmicro_des, const char_T *c2_name, real_T c2_y[3]);
  ...
  (SFc2_twa_parallelInstanceStruct *chartInstance)
{
  ...
  c2_qmicro_des = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_is_active_c2_twa_parallel = (uint8_T *)ssGetDWork(chartInstance->S, 2);
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2));
  for (c2_i0 = 0; c2_i0 < 3; c2_i0 = c2_i0 + 1) {
    c2_hoistedGlobal[c2_i0] = (*c2_qmicro_des)[c2_i0];
  }
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_doneDoubleBufferReInit = TRUE;
  ...
  for (c2_i2 = 0; c2_i2 < 3; c2_i2 = c2_i2 + 1) {
    (*c2_qmicro_des)[c2_i2] = c2_dv0[c2_i2];
  }
...
static void sf_c2_twa_parallel(SFc2_twa_parallelInstanceStruct *chartInstance)
{
  ...
  int32_T c2_i10;
  int32_T c2_i11;
  static real_T c2_dv1[3] = { 2.258E+002, 2.263E+002, 224.5 };
  ...
  for (c2_i5 = 0; c2_i5 < 3; c2_i5 = c2_i5 + 1) {
    _SFD_DATA_RANGE_CHECK((*c2_b_qmicro_des)[c2_i5], 2U);
  }
  ...
  for (c2_i6 = 0; c2_i6 < 6; c2_i6 = c2_i6 + 1) {
    c2_hoistedGlobal[c2_i6] = (*c2_b_q_cur)[c2_i6];
  }
  ...
  for (c2_i8 = 0; c2_i8 < 6; c2_i8 = c2_i8 + 1) {
    c2_q_cur[c2_i8] = c2_hoistedGlobal[c2_i8];
  }
  ...
  sf_debug_symbol_scope_add_eml(&c2_init_len, c2_sf_marshall, 0U);
  sf_debug_symbol_scope_add_eml(&c2_wire_rad, c2_c_sf_marshall, 1U);
  sf_debug_symbol_scope_add_eml(&c2_q_mu, c2_sf_marshall, 2U);
  ...
  for (c2_i10 = 0; c2_i10 < 3; c2_i10 = c2_i10 + 1) {
    c2_qmicro_des[c2_i10] = c2_q_cur[c2_i10 + 3];
  }

  _SFD_EML_CALL(0,7);
  for (c2_i11 = 0; c2_i11 < 3; c2_i11 = c2_i11 + 1) {
    c2_init_len[c2_i11] = c2_dv1[c2_i11];
  }
  ...
  c2_b_x = c2_x;
  c2_c_x = c2_b_x;
  c2_y = c2_c_x / 1.9516089999999996E-002;
  c2_d_x = c2_y;
  c2_e_x = c2_d_x;
  if (c2_e_x < 0.0) {
  ...
  c2_qmicro_des[0] = c2_e_x;

  /* [rad] */
  _SFD_EML_CALL(0,16);
  c2_b_A = c2_mpower(chartInstance, 2.263E+002) - c2_mpower(chartInstance,
    c2_q_mu[1]);
  c2_g_x = c2_b_A;
  c2_h_x = c2_g_x;
  c2_i_x = c2_h_x;
  c2_b_y = c2_i_x / 1.9516089999999996E-002;
  c2_j_x = c2_b_y;
  c2_k_x = c2_j_x;
  if (c2_k_x < 0.0) {
    c2_eml_error(chartInstance);
  ...
  c2_qmicro_des[1] = c2_k_x;
  _SFD_EML_CALL(0,17);
  c2_c_A = c2_mpower(chartInstance, 224.5) - c2_mpower(chartInstance, c2_q_mu[2]);
  c2_m_x = c2_c_A;
  c2_n_x = c2_m_x;
  c2_o_x = c2_n_x;
  c2_c_y = c2_o_x / 1.9516089999999996E-002;
  c2_p_x = c2_c_y;
  c2_q_x = c2_p_x;
  if (c2_q_x < 0.0) {
    c2_eml_error(chartInstance);
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  for (c2_i21 = 0; c2_i21 < 3; c2_i21 = c2_i21 + 1) {
    c2_b_u[c2_i21] = (*((real_T (*)[3])c2_u))[c2_i21];
  }
...
static const mxArray *c2_b_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  for (c2_i22 = 0; c2_i22 < 6; c2_i22 = c2_i22 + 1) {
    c2_b_u[c2_i22] = (*((real_T (*)[6])c2_u))[c2_i22];
  }
...
const mxArray *sf_c2_twa_parallel_get_eml_resolved_functions_info(void)
{
  ...
  for (c2_i23 = 0; c2_i23 < 34; c2_i23 = c2_i23 + 1) {
    ...
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c2_i23
                    );
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c2_i23
                    );
  }
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[34])
{
  ...
  c2_info[11].context = "";
  c2_info[11].name = "mrdivide";
  c2_info[11].dominantType = "double";
  c2_info[11].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[11].fileLength = 800U;
  c2_info[11].fileTime1 = 1238459490U;
  c2_info[11].fileTime2 = 0U;
  c2_info[12].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[12].name = "ge";
  c2_info[12].dominantType = "double";
  c2_info[12].resolved = "[B]ge";
  ...
  c2_info[13].fileLength = 403U;
  c2_info[13].fileTime1 = 1244760752U;
  c2_info[13].fileTime2 = 0U;
  c2_info[14].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[14].name = "eml_div";
  c2_info[14].dominantType = "double";
  c2_info[14].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c2_info[14].fileLength = 4269U;
  c2_info[14].fileTime1 = 1228119026U;
  ...
  c2_info[18].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[18].fileLength = 3710U;
  c2_info[18].fileTime1 = 1238459488U;
  c2_info[18].fileTime2 = 0U;
  c2_info[19].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  ...
  c2_info[20].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[20].name = "power";
  c2_info[20].dominantType = "double";
  c2_info[20].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[20].fileLength = 5380U;
  c2_info[20].fileTime1 = 1228119098U;
  ...
  c2_info[21].fileTime1 = 1240287210U;
  ...
  c2_info[28].fileTime1 = 1209355990U;
  ...
  c2_info[30].fileTime1 = 1213951944U;
...
static void c2_emlrt_marshallIn(SFc2_twa_parallelInstanceStruct *chartInstance,
  const mxArray *c2_qmicro_des, const char_T *c2_name
  , real_T c2_y[3])
{
  real_T c2_dv2[3];
  int32_T c2_i24;
  sf_mex_import(c2_name, sf_mex_dup(c2_qmicro_des), &c2_dv2, 1, 0, 0U, 1, 0U, 1,
                3);
  for (c2_i24 = 0; c2_i24 < 3; c2_i24 = c2_i24 + 1) {
    c2_y[c2_i24] = c2_dv2[c2_i24];
  }

  sf_mex_destroy(&c2_qmicro_des);
}
...
static mxArray *sf_get_sim_state_info_c2_twa_parallel(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[16],T\"qmicro_des\",},{M[8],M[0],T\"is_active_c2_twa_parallel\",}}"
  };
        ...
        if (chartAlreadyPresent==0) {
...

          {
            ...
            _SFD_SET_DATA_PROPS(0,1,1,0,SF_DOUBLE,1,&(dimVector[0]),0,0,0,0.0,
                                1.0,0,"q_cur",0,(MexFcnForType)c2_b_sf_marshall);
          }
...

          {
            ...
            _SFD_SET_DATA_PROPS(2,2,0,1,SF_DOUBLE,1,&(dimVector[0]),0,0,0,0.0,
                                1.0,0,"qmicro_des",0,(MexFcnForType)
                                c2_sf_marshall);
          }
...
static void mdlSetWorkWidths_c2_twa_parallel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"twa_parallel","twa_parallel",2,2);
