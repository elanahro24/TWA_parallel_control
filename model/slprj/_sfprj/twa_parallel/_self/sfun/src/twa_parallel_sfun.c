  ...
  int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==4) {
    c4_twa_parallel_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      switch (chartFileNumber) {
       ...
       case 4:
        {
          extern void sf_c4_twa_parallel_get_check_sum(mxArray *plhs[]);
          sf_c4_twa_parallel_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3423316161U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3628064567U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4264690518U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2149384705U);
  }
     ...
     case 4:
      {
        extern const mxArray *sf_c4_twa_parallel_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c4_twa_parallel_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
