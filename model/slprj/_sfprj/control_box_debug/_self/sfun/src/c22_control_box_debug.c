...
#include "control_box_debug_sfun_debug_macros.h"
...
static void initialize_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance);
static void initialize_params_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance);
static void enable_c22_control_box_debug(SFc22_control_box_debugInstanceStruct
  *chartInstance);
static void disable_c22_control_box_debug(SFc22_control_box_debugInstanceStruct *
  chartInstance);
static void c22_update_debugger_state_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance);
static void ext_mode_exec_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance);
static void set_sim_state_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance, const mxArray *c22_st);
static void finalize_c22_control_box_debug(SFc22_control_box_debugInstanceStruct
  *chartInstance);
static void sf_c22_control_box_debug(SFc22_control_box_debugInstanceStruct
  *chartInstance);
static void c22_c22_control_box_debug(SFc22_control_box_debugInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c22_machineNumber, uint32_T
  c22_chartNumber);
static void c22_eml_scalar_eg(SFc22_control_box_debugInstanceStruct
  *chartInstance);
static real_T c22_ceval_xdot(SFc22_control_box_debugInstanceStruct
  *chartInstance, int32_T c22_n, real_T c22_x[6], int32_T c22_ix0, int32_T
  c22_incx, real_T c22_y[6], int32_T c22_iy0, int32_T c22_incy);
static real_T c22_power(SFc22_control_box_debugInstanceStruct *chartInstance,
  real_T c22_a, real_T c22_b);
static void c22_eml_error(SFc22_control_box_debugInstanceStruct *chartInstance);
...
static real_T c22_emlrt_marshallIn(SFc22_control_box_debugInstanceStruct
  *chartInstance, const mxArray *c22_confn, const char_T *c22_name);
static void c22_b_emlrt_marshallIn(SFc22_control_box_debugInstanceStruct
  *chartInstance, const mxArray *c22_q0n, const char_T *c22_name, real_T c22_y[6]);
static uint8_T c22_c_emlrt_marshallIn(SFc22_control_box_debugInstanceStruct
  *chartInstance, const mxArray *c22_is_active_c22_control_box_debug, const
  char_T *c22_name);
static void init_dsm_address_info(SFc22_control_box_debugInstanceStruct
  *chartInstance);
...
static void initialize_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance)
{
  uint8_T *c22_is_active_c22_control_box_debug;
  c22_is_active_c22_control_box_debug = (uint8_T *)ssGetDWork(chartInstance->S,
    2);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c22_is_active_c22_control_box_debug = 0U;
}
...
static void ext_mode_exec_c22_control_box_debug
  (SFc22_control_box_debugInstanceStruct *chartInstance)
{
  c22_update_debugger_state_c22_control_box_debug(chartInstance);
}
  ...
  (SFc22_control_box_debugInstanceStruct *chartInstance)
{
  ...
  c22_h_hoistedGlobal = *c22_is_active_c22_control_box_debug;
  ...
  (SFc22_control_box_debugInstanceStruct *chartInstance, const mxArray *c22_st)
{
  ...
  *c22_t0n = c22_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c22_u,
    6)), "t0n");
  *c22_is_active_c22_control_box_debug = c22_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c22_u, 7)),
    "is_active_c22_control_box_debug");
  ...
  *chartInstance)
{
  ...
  c22_c22_control_box_debug(chartInstance);
  _sfEvent_ = c22_previousEvent;
  sf_debug_check_for_state_inconsistency(_control_box_debugMachineNumber_,
...
static real_T c22_ceval_xdot(SFc22_control_box_debugInstanceStruct
  *chartInstance, int32_T c22_n, real_T c22_x[6], int32_T c22_ix0,
...
static const mxArray *c22_sf_marshall(void *chartInstanceVoid, void *c22_u)
{
  ...
  const mxArray *c22_b_y = NULL;
  SFc22_control_box_debugInstanceStruct *chartInstance;
  chartInstance = (SFc22_control_box_debugInstanceStruct *)chartInstanceVoid;
  c22_y = NULL;
...
const mxArray *sf_c22_control_box_debug_get_eml_resolved_functions_info(void)
{
...
static real_T c22_emlrt_marshallIn(SFc22_control_box_debugInstanceStruct
  *chartInstance, const mxArray *c22_confn, const char_T *
  c22_name)
{
  real_T c22_y;
  real_T c22_d0;
...
static void c22_b_emlrt_marshallIn(SFc22_control_box_debugInstanceStruct
  *chartInstance, const mxArray *c22_q0n, const char_T *
  c22_name, real_T c22_y[6])
{
  real_T c22_dv4[6];
  int32_T c22_i131;
...
static uint8_T c22_c_emlrt_marshallIn(SFc22_control_box_debugInstanceStruct
  *chartInstance, const mxArray *
  c22_is_active_c22_control_box_debug, const char_T *c22_name)
{
  uint8_T c22_y;
  uint8_T c22_u0;
  sf_mex_import(c22_name, sf_mex_dup(c22_is_active_c22_control_box_debug),
                &c22_u0, 1, 3, 0U, 0, 0U, 0);
  c22_y = c22_u0;
  sf_mex_destroy(&c22_is_active_c22_control_box_debug);
  return c22_y;
}
...
/* SFunction Glue Code */
void sf_c22_control_box_debug_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c22_control_box_debug_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c22_control_box_debug(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[12],T\"confn\",},{M[1],M[15],T\"q0n\",},{M[1],M[31],T\"q_cmd\",},{M[1],M[25],T\"q_dot\",},{M[1],M[32],T\"q_dub_dot\",},{M[1],M[33],T\"robot_mov\",},{M[1],M[14],T\"t0n\",},{M[8],M[0],T\"is_active_c22_control_box_debug\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_control_box_debug_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc22_control_box_debugInstanceStruct *chartInstance;
    chartInstance = (SFc22_control_box_debugInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_control_box_debugMachineNumber_,
           22,
           1,
           1,
           15,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_control_box_debugMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_control_box_debugMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_control_box_debugMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration
        (_control_box_debugMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c22_control_box_debug(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar);
  initialize_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c22_control_box_debug(void *chartInstanceVar)
{
  enable_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c22_control_box_debug(void *chartInstanceVar)
{
  disable_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c22_control_box_debug(void *chartInstanceVar)
{
  sf_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c22_control_box_debug(void *chartInstanceVar)
{
  ext_mode_exec_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c22_control_box_debug(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c22_control_box_debug
    ((SFc22_control_box_debugInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c22_control_box_debug();/* state var info */
...
static void sf_internal_set_sim_state_c22_control_box_debug(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c22_control_box_debug();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c22_control_box_debug(SimStruct* S)
{
  return sf_internal_get_sim_state_c22_control_box_debug(S);
}

static void sf_opaque_set_sim_state_c22_control_box_debug(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c22_control_box_debug(S, st);
}

static void sf_opaque_terminate_c22_control_box_debug(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_control_box_debugInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c22_control_box_debug((SFc22_control_box_debugInstanceStruct*)
      chartInstanceVar);
...
static void mdlProcessParameters_c22_control_box_debug(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c22_control_box_debug
      ((SFc22_control_box_debugInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlSetWorkWidths_c22_control_box_debug(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("control_box_debug","control_box_debug",22);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("control_box_debug","control_box_debug",
                22,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("control_box_debug",
      "control_box_debug",22,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"control_box_debug",
        "control_box_debug",22,8);
      sf_mark_chart_reusable_outputs(S,"control_box_debug","control_box_debug",
        22,7);
    }

    sf_set_rtw_dwork_info(S,"control_box_debug","control_box_debug",22);
...
static void mdlRTW_c22_control_box_debug(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "control_box_debug", "control_box_debug",22);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c22_control_box_debug(SimStruct *S)
{
  SFc22_control_box_debugInstanceStruct *chartInstance;
  chartInstance = (SFc22_control_box_debugInstanceStruct *)malloc(sizeof
    (SFc22_control_box_debugInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_control_box_debugInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c22_control_box_debug;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c22_control_box_debug;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c22_control_box_debug;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_control_box_debug;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c22_control_box_debug;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c22_control_box_debug;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c22_control_box_debug;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c22_control_box_debug;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_control_box_debug;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_control_box_debug;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c22_control_box_debug;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c22_control_box_debug;
...
void c22_control_box_debug_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_control_box_debug(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_control_box_debug(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_control_box_debug(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_control_box_debug_method_dispatcher.\n"
