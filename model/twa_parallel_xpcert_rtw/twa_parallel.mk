...
#
# File    : xpc_vc.tmf   $Revision: 1.1.8.21 $ $Date: 2009/08/29 08:30:24 $
#
# Abstract:
...
BUILD           = yes
MAKECMD         = nmake
SYS_TARGET_FILE = xpctargetert.tlc
...
TID01EQ         = 1
NCSTATES        = 6
BUILDARGS       =  GENERATE_REPORT=1 INCLUDE_MDL_TERMINATE_FCN=1 COMBINE_OUTPUT_UPDATE_FCNS=0 MAT_FILE=1 MULTI_INSTANCE_CODE=0 INTEGER_CODE=0 PORTABLE_WORDSIZES=0 EXT_MODE=1
MULTITASKING    = 0
EXT_MODE        = 0
