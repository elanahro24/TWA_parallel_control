...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&twa_parallel_B.EncoderInput_o1), 0, 0, 289 },

  { (char_T *)(&twa_parallel_B.NSampleEnable), 8, 0, 1 }
  ,

  { (char_T *)(&twa_parallel_DWork.DiscreteFIRFilter_states[0]), 0, 0, 59 },
  ...
  { (char_T *)(&twa_parallel_DWork.is_active_c2_twa_parallel), 3, 0, 6 },

  { (char_T *)(&twa_parallel_DWork.isStable), 8, 0, 12 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&twa_parallel_P.eq_eps_Value), 0, 0, 169 },
